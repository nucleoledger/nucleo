...
**Estado:** ACEPTADA el 2026-09-18 por el dev (Sprint 8) · **Fecha:** 2026-09-18 · **Fuentes:** cuarta auditoría (F.6, la regla anti-circularidad); ADR-007 (ML-DSA-44 adicional), `testdata/vectors/receipt/generar.py`, `internal/receipt/vectors_export_test.go`
