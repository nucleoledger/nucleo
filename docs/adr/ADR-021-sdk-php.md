...
**Estado:** ACEPTADA el 2026-09-17 por el dev (Sprint 8) · **Fecha:** 2026-09-17 · **Fuentes:** auditoría externa (H9, "cómo sella un ERP PHP en la misma transacción"); ADR-005 (CLI primaria), ADR-009 (esquema), ADR-017 y ADR-018 (la política como raíz de confianza y como formato de cable), ADR-020 (idempotencia), PROTOCOL.md §2.1, §3.1, §3.2, §3.3 y §5
