...
func TestVerifyConsistencyErrorPaths(t *testing.T) {
	...
	cases := []struct {
		...
		{"tamaños iguales con raíces distintas", 8, 8, oldRoot3, newRoot, nil, ErrBadProof},
		{"tamaños iguales con prueba no vacía", 8, 8, newRoot, newRoot, proof3, ErrBadProof},
		{"prueba vacía con oldSize no potencia de dos", 3, 8, oldRoot3, newRoot, nil, ErrBadProof},
		{"prueba vacía con oldSize potencia de dos", 4, 8, oldRoot4, newRoot, nil, ErrBadProof},
