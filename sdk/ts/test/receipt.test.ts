...
describe("vectores de recibo generados por Go", () => {
  ...
  it("hay catorce vectores: los tres originales, nueve de tamaño (1; y 2, 4, 8, 9 × índices 0 y último), el destinatario que imita una firma y la cosignature duplicada", () => {
